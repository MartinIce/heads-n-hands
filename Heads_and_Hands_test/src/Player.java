public class Player extends Creature {
    int maxHealth;
    public Player(String _name, int _attack, int _defence, int _health, int _lowDamage, int _highDamage, boolean _alive){
        this.setName(_name);
    ...
    public void heal(){
        setHealth((int) Math.round(this.getHealth()+ maxHealth*0.3));
    ...
    public void kick(Creature attacked){
        ...
        System.out.println("Нанесено урона противнику: " + dmg);
    }
}
